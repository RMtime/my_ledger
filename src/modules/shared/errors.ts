export type ErrorCode = "VALIDATION_ERROR" | "UNAUTHENTICATED" | "FORBIDDEN" | "NOT_FOUND" | "IDEMPOTENCY_CONFLICT" | "VERSION_CONFLICT" | "RATE_LIMITED" | "CONFLICT" | "AI_NOT_CONFIGURED" | "AI_ERROR";
